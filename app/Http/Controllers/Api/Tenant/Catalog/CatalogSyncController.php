...
class CatalogSyncController extends Controller
{
     ...
     *                     @OA\Property(property="barcodes", type="integer", example=135),
     *                     @OA\Property(property="scale_barcode_formats", type="integer", example=1),
     ...
     *                         @OA\Property(property="is_active", type="boolean", example=true)
     *                     )),
     *                     @OA\Property(property="barcodes", type="array", @OA\Items(type="object",
     ...
     *                         @OA\Property(property="updated_at", type="string", format="date-time", example="2026-08-12T10:20:30.000000Z"),
     *                         @OA\Property(property="deleted_at", type="string", format="date-time", nullable=true, example=null),
     *                         @OA\Property(property="barcodeable_type", type="string", example="App\\Models\\Tenant\\Product"),
     *                         @OA\Property(property="barcodeable_id", type="integer", example=10),
     ...
     *                         @OA\Property(property="sale_line", type="object", description="Offline POS-ready sale line defaults matching the product-barcodes lookup response.",
     ...
     *                             @OA\Property(property="product_uom_id", type="integer", nullable=true, example=40),
     ...
     *                             @OA\Property(property="sale_item_payload", type="object",
     *                                 @OA\Property(property="product_id", type="integer", example=10),
     *                                 @OA\Property(property="variant_id", type="integer", nullable=true, example=null),
     ...
     *                         )
     *                     )),
     *                     @OA\Property(property="scale_barcode_formats", type="array", @OA\Items(type="object",
     *                         @OA\Property(property="id", type="integer", example=1),
     *                         @OA\Property(property="deleted", type="boolean", example=false),
     *                         @OA\Property(property="synced_at", type="string", format="date-time", example="2026-08-12T10:20:30.000000Z"),
     *                         @OA\Property(property="created_at", type="string", format="date-time", example="2026-08-01T10:20:30.000000Z"),
     ...
     *                         @OA\Property(property="metadata", type="object"),
     *                         @OA\Property(property="notes", type="string", nullable=true, example="Mobile should parse after static barcode miss and resolve extracted PLU against SCALE barcodes.")
     *                     )),
