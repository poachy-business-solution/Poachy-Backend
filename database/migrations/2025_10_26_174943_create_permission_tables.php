...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::connection('central')->drop($tableNames['role_has_permissions']);
        Schema::connection('central')->drop($tableNames['model_has_roles']);
        Schema::connection('central')->drop($tableNames['model_has_permissions']);
        Schema::connection('central')->drop($tableNames['roles']);
        Schema::connection('central')->drop($tableNames['permissions']);
    }
};
