...
class MarketplaceBrandSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $brands = [
            ...
            ['name' => 'Levis', 'description' => 'Denim jeans and casual wear', 'is_featured' => false, 'display_order' => 43],
        ...
        foreach ($brands as $brand) {
            ...
            $existingBrand = DB::connection('central')
