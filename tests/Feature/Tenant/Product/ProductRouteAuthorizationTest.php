...
class ProductRouteAuthorizationTest extends TestCase
{
    ...
    public static function manageProductsGatedRoutes(): array
    {
        return [
            ...
            'product barcode pending suggestions' => ['GET', 'api/v1/tenant/product-barcodes/suggestions/pending'],
            'product barcode approve suggestion' => ['POST', 'api/v1/tenant/product-barcodes/suggestions/{suggestion}/approve'],
            'product barcode reject suggestion' => ['POST', 'api/v1/tenant/product-barcodes/suggestions/{suggestion}/reject'],
            'product barcode manual' => ['POST', 'api/v1/tenant/product-barcodes/manual'],
            'product barcode scanned' => ['POST', 'api/v1/tenant/product-barcodes/scanned'],
            'product barcode generated' => ['POST', 'api/v1/tenant/product-barcodes/generated'],
            'product barcode imported' => ['POST', 'api/v1/tenant/product-barcodes/imported'],
            'product barcode supplier' => ['POST', 'api/v1/tenant/product-barcodes/supplier'],
            'product barcode scale' => ['POST', 'api/v1/tenant/product-barcodes/scale'],
            'product barcode destroy' => ['DELETE', 'api/v1/tenant/product-barcodes/{barcode}'],
            'scale barcode format store' => ['POST', 'api/v1/tenant/product-scale-barcode-formats'],
            'scale barcode format update' => ['PATCH', 'api/v1/tenant/product-scale-barcode-formats/{scaleBarcodeFormat}'],
            'scale barcode format destroy' => ['DELETE', 'api/v1/tenant/product-scale-barcode-formats/{scaleBarcodeFormat}'],
    ...
    public static function openReadRoutes(): array
    {
        return [
            ...
            'product barcode suggestion submit' => ['POST', 'api/v1/tenant/product-barcodes/suggestions'],
            'scale barcode format index' => ['GET', 'api/v1/tenant/product-scale-barcode-formats'],
            'scale barcode format show' => ['GET', 'api/v1/tenant/product-scale-barcode-formats/{scaleBarcodeFormat}'],
        ];
    }
